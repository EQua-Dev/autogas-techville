...
export const conferenceFormFields = [
  ...
  { name: "phoneNumber", label: "Phone Number", type: "text", placeholder: "Enter your phone number", validation: z.string().regex(/^[0-9]{11}$/, "Phone number must be 11 digits") },
